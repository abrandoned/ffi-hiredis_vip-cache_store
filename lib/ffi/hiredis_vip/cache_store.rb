...
require "ffi/hiredis_vip/cache_store/address"
require "ffi/hiredis_vip/cache_store/marshal_client"
  ...
  module HiredisVip
    module CacheStore
      class Store < ::ActiveSupport::Cache::Store
        ...
        #
        # Example:
        #   FFI::HiredisVip::CacheStore::Store.new
        #     # => host: localhost,   port: 6379,  db: 0
        #
        #   FFI::HiredisVip::CacheStore::Store.new "example.com"
        #     # => host: example.com, port: 6379,  db: 0
        #
        #   FFI::HiredisVip::CacheStore::Store.new "example.com:23682"
        #     # => host: example.com, port: 23682, db: 0
        #
        #   FFI::HiredisVip::CacheStore::Store.new "example.com:23682/1"
        #     # => host: example.com, port: 23682, db: 1
        #
        #   FFI::HiredisVip::CacheStore::Store.new "localhost:6379/0", "localhost:6380/0"
        ...
        def initialize(*addresses)
          ...
          @connection_pool = ::ConnectionPool.new(pool_options) {
            address = ::FFI::HiredisVip::CacheStore::Address.new(addresses.first)
            connection_options = {}
        ...
        def write(name, value, options = nil)
          ...
          instrument(:write, name, options) do |payload|
            entry = options[:raw].present? ? value : ::ActiveSupport::Cache::Entry.new(value, options)
        ...
        def write_entry(key, entry, options)
          with { |client| client.set key, entry, options }
        rescue Errno::ECONNREFUSED, Errno::EHOSTUNREACH
          raise if raise_errors?
          false
        end
